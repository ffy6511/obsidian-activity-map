...
- [x] Stable multi-slice header mini donut, idle-bounded real-time `3:2` chart/list Popover with basename-only file leaves, dockable full view, and complete synchronized scrollable detail list.

...
- [x] Header status entry, interactive summary popover, dockable full view, hierarchical donut chart, and complete detail list.
...
- [x] Keyboard, focus, accessible-name, non-color encoding, theme, and reduced-motion checks pass.

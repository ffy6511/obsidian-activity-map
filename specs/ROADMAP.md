...
- [x] Users can reorder or recoverably disable the six configurable actions in the actual Header Popover row while its fixed day navigation remains centered and unchanged.

...
- [ ] Stable data-backed header mini donut, interactive hierarchical donut popover, dockable full view, and complete synchronized detail list.
...
- [ ] Keyboard, focus, pin/unpin, accessible-name, non-color encoding, theme, and reduced-motion checks pass across the header donut popover and full view.
